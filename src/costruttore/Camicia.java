...
public class Camicia {
	...
	// costruttore personalizzato: riceve argomenti nelle aprentesi tonde, come un metodo
	...
	public void setCodiceColore(char codiceColore)
	{
		...
		do {
			...
			case 'W':
				...
				break;
			default:
				System.out.println("Codici consentiti: R = red, G = green, B = blue, W = white, reinseriscilo:");
	...
	public void setAcquistate(int acquistate){
		...
		do {
			if(acquistate > 0 && acquistate <= getDisponibili()) // getDisponibili() perchè disponibili è private, e l'unico private accessibile direttamente è quello che dà il nome al setter
			{
				...
				System.out.print("Occorre acquistare almeno una camicia e al massimo " + getDisponibili() + "; reinserisci:");
